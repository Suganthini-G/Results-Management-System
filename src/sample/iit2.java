...
public class iit2 {
    ...
    public iit2(String stuno, String SystemAnalysisandDesign, String SoftwareEngineering,String Network2, String Programming, String FinancialAccounting,String AestheticStudies, String gpa) {
        this.eno = stuno;
        this.col2 = SystemAnalysisandDesign;
        this.col3 = SoftwareEngineering;
        this.col4 = Network2;
        this.col5 = Programming;
        this.col6 = FinancialAccounting;
